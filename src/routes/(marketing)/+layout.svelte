...
<div class="navbar bg-base-100 container mx-auto">
  <div class="flex-1">
    <a class="btn btn-ghost normal-case text-xl" href="/">
      <!-- <div
        class="text-xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-secondary via-primary to-accent"
      >
        Volare Solutions
      </div> -->
      <svg
        ...
        ></path></svg
      >
      <div class="md:mx-2">Volare Solutions</div>
    </a>
  </div>
  <div class="flex-none">
...
<div class="">
  ...
  <footer
    class="footer px-10 py-4 border-t text-base-content max-w-[1000px] mx-auto"
  >
    <aside class="items-center grid-flow-col">
      <svg
        ...
        ></path></svg
      >
      <p>Volare Solutions LLC <br />Providing reliable services since 2023</p>
    </aside>
